...
<div class="auth-container">
    ...
    <div class="auth-light-panel">
        ...
        <form id="memberForm" class="auth-form" action="MemberRegisterServlet" method="post" enctype="multipart/form-data" onsubmit="return validatePhoto()">
            ...
            <div class="form-row">
                <div class="form-group"><input type="tel" name="contactNo" placeholder="Contact No (e.g. 9876543210)" pattern="[6-9][0-9]{9}" maxlength="10" title="Enter a valid 10-digit Indian mobile number starting with 6-9" oninput="this.value=this.value.replace(/[^0-9]/g,'')" required></div>
