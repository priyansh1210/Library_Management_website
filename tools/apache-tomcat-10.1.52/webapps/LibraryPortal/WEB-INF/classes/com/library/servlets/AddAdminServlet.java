...
public class AddAdminServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (name.isEmpty() || email == null || email.trim().isEmpty()
            ...
            response.sendRedirect("adminAdmins.jsp?msg=All fields required, password min 4 chars");
            return;
        }
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            if (check.executeQuery().next()) {
                response.sendRedirect("adminAdmins.jsp?msg=Email or username already registered");
                return;
            }
            ...
            ps.executeUpdate();
            ps.close();
            response.sendRedirect("adminAdmins.jsp?msg=Admin added successfully");
        } catch (Exception e) {
            e.printStackTrace();
            response.sendRedirect("adminAdmins.jsp?msg=Add failed: " + e.getMessage());
        }
    }
}
